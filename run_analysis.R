# Step-by-step instructions for Peer Graded Assignment: Getting and Cleaning Data Course Project
...
## step 3: unzip data
listZip <- unzip("./data/assignment.zip", exdir = "./data")
...
## step 5: merge train dan test data
...
write.table(groupData, file = "TidyData.txt", row.names = FALSE)
